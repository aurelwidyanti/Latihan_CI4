<?php
    ...
    class TransaksiController extends BaseController
    {
		...
		private $apiKey = "fb6b18f0c71d973f8e0860393c3c99c4";
        ...
        public function cart_add()
        {
            ...
            session()->setflashdata('success', 'Product successfully added to cart. (<a href="' . base_url() . 'keranjang">See</a>)');
        ...
        {
            $this->cart->destroy();
            session()->setflashdata('success', 'Cart has been successfully emptied.');
        ...
        public function cart_edit()
        {
            ...
            session()->setflashdata('success', 'Cart successfully updated.');
            return redirect()->to(base_url('keranjang'));
        }
        ...
        public function cart_delete($rowid)
        {
            ...
            session()->setflashdata('success', 'Cart successfully deleted.');
            return redirect()->to(base_url('keranjang'));
        }
