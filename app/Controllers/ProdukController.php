		...
		class ProdukController extends BaseController
		{
			...
			public function create()
			{
				...
				if(!$errors){
					...
					return redirect('produk')->with('success','Data successfully added.');
				}else{
			...
			public function edit($id)
			{
				...
				if(!$errors){
					...
					return redirect('produk')->with('success','Data successfully updated.');
				}else{
			...
			public function delete($id)
			{
				...
				return redirect('produk')->with('success','Data successfully deleted.');
			}
		}